...
xtick = [0.000001, 0.000002, 0.000005, 0.00001, 0.00002, 0.00005, 0.0001, 0.0002, 0.0005, 0.001, 0.002, 0.005, 0.01, 0.02, 0.05, ...
         0.1, 0.2, 0.5];
xticklabel = {'0.0001', '0.0002', '0.0005', '0.001', '0.002', '0.005', '0.01', '0.02', '0.05', '0.1', '0.2', '0.5', '1', '2', '5', '10', '20', '50'};
% xticklabel = num2str(xtick * 100, '%g\n');
% xticklabel = textscan(xticklabel, '%s'); xticklabel = xticklabel{1};
set (gca, 'xtick', my_icdf(xtick));
set(gca, 'xticklabel', xticklabel);
xlim(my_icdf([0.000007 0.1]));
