function [x, covMat]= extract_ivector(statFilename, ubmFilename, tvFilename, ivFilename, saveCovMat)
...
if (nargin == 5 && saveCovMat)
    covMat = pinv(L);
%    covMat = covMat/(norm(x)^2);
end
if (nargin == 4 && ~isempty(ivFilename)) 
