function T = train_tv_space(dataList, ubmFilename, tv_dim, niter, nworkers, tvFilename, seed)
...
for iter = 1 : niter
    ...
    tim = toc(tim);
    diff_trace = trace(T * T') - trace(oldT * oldT');
...
parts = 150; % modify this based on your resources
